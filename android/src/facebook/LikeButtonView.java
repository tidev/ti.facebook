...
public class LikeButtonView extends TiUIView 
{
	...
	private class LikeControllerBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
    		...
    		Log.d(TAG, "[LIKEBUTTON] LikeControllerBroadcastReceiver "+intentAction);
	...
	{
		Log.d(TAG, "[LIKEBUTTON] Like status change deected");
		triggerStatusChangedEvent(); //Call js event 'statuschanged'
	}
	
    public void triggerStatusChangedEvent() {
    	Log.d(TAG, "[LIKEBUTTON] triggerStatusChangedEvent ");
	...
	public LikeButtonView(TiViewProxy proxy) 
	{
        ...
        LocalBroadcastManager localBroadcastManager =
                LocalBroadcastManager.getInstance(proxy.getActivity());
	...
	private void setLikeViewStyle(String name) {
    	Log.d(TAG, "[LIKEBUTTON] setLikeViewStyle "+name);
	...
	private void setAuxiliaryViewPosition(String name) {
    	Log.d(TAG, "[LIKEBUTTON] setAuxiliaryViewPosition "+name);
	...
	private void setHorizontalAlignment(String name) {
    	Log.d(TAG, "[LIKEBUTTON] setHorizontalAlignment "+name);
	...
	public void processProperties(KrollDict props) 
	{
		...
		if (props.containsKey("objectId")) {
			this.objectId = props.getString("objectId");
	...
	public void propertyChanged(String key, Object oldValue, Object newValue, KrollProxy proxy)
	{
		...
		if (key.equals("objectId")) {
			this.objectId = TiConvert.toString(newValue);
