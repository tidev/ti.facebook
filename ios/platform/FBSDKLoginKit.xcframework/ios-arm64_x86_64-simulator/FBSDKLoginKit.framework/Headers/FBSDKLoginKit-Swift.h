...
SWIFT_PROTOCOL_NAMED("UserInterfaceStringProviding")
@protocol FBSDKUserInterfaceStringProviding
@property (nonatomic, readonly, strong) NSBundle * _Nonnull bundleForStrings;
@end


@interface FBSDKInternalUtility (SWIFT_EXTENSION(FBSDKLoginKit)) <FBSDKUserInterfaceStringProviding>
@end

@class UIViewController;
@class UIView;

SWIFT_PROTOCOL_NAMED("UserInterfaceElementProviding")
@protocol FBSDKUserInterfaceElementProviding
...
@interface FBSDKInternalUtility (SWIFT_EXTENSION(FBSDKLoginKit)) <FBSDKUserInterfaceElementProviding>
@end
