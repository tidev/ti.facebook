...
/// API Subject to change or removal without warning. Do not use.
/// @warning INTERNAL - DO NOT USE
SWIFT_CLASS("_TtC12FBSDKCoreKit17CoreUIApplication") SWIFT_AVAILABILITY(tvos,unavailable)
...
SWIFT_CLASS_NAMED("FBProfilePictureView") SWIFT_AVAILABILITY(tvos,unavailable)
