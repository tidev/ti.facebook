...
{
  DEPRECATED_REPLACED(@"Facebook.LoginButton.publishPermissions", @"6.1.0", @"Facebook.LoginButton.permissions");
...
{
  DEPRECATED_REPLACED(@"Facebook.LoginButton.readPermissions", @"6.1.0", @"Facebook.LoginButton.permissions");
